...
if ($portfolio_layout == 'default') {
	...
	elseif ( get_theme_mod( 'theme_version') == 'theme_version_masonry') { $portfolio_layout = 'masonry'; }
	elseif ( get_theme_mod( 'theme_version') == 'theme_version_masonry_full') { $portfolio_layout = 'masonry'; }
...
if ($portfolio_layout != 'fullscreen') {  ?>
	...
	<div class="row fadein<?php if ($portfolio_layout == 'std') { echo ' portfolio';} if ($portfolio_layout == 'edge') { echo ' edge fullscreen';} ?>">
...
<!--				<li>--><?php //get_template_part( 'content', 'portfolio-media' ); ?><!--</li>-->
		...
		<?php if ($portfolio_layout == 'edge' OR $portfolio_layout == 'std') { ?>
			<div class="row <?php if ($portfolio_layout == 'std') { echo "row_std"; } ?>">
...
?>
	...
	<div class="row portfolio fadein<?php if ($full == true) { echo ' fullscreen';} ?>">
		
		<?php if ( !post_password_required() ) { // START PASSWORD PROTECTED	?>

			<ul id="masonry-container" class="grid <?php if ($full == true) { echo ' fullscreen';} ?> <?php echo get_theme_mod( 'portfolio_column_width');?>">
				
				<?php bean_gallery($post->ID, 'port-grid-lightbox', 'single-port-masonry-lightbox' , $orderby , true); ?>
...
<?php } //END if ($portfolio_layout == 'masonry')
