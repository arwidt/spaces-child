...
<body <?php body_class(); ?>> <?php bean_body_start(); ?>
	...
	{ 
		...
		if ($portfolio_layout == 'default') {
			...
			elseif ( get_theme_mod( 'theme_version') == 'theme_version_edge') { $portfolio_layout = 'fullwidth'; }
		...
		<div id="theme-wrapper" class="<?php echo $theme_style; ?> <?php echo $header_style; ?>">
			...
			<div class="row">
				...
				<header id="header">
					...
					is_page_template('template-dribbble.php') OR
					...
					is_page_template('template-dribbble-fullwidth.php') OR
					...
					is_singular('portfolio') && $portfolio_content_display == 'off'
						...
						if ($content) { 
								...
								if ( is_singular('portfolio') && get_theme_mod( 'show_portfolio_sharing' ) == true ) { ?>
					...
					<nav class="primary subtext clearfix">
						...
						<?php if( get_theme_mod( 'portfolio_filter' ) == true ) { 
